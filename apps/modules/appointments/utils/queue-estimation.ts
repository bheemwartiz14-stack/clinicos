import type { AppointmentPriority, QueueRecord } from "../types/appointment.types";
...
export function estimateQueuePosition(queue: QueueRecord[], priority: AppointmentPriority) {
